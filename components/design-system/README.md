...
See the root README for browser regressions and reproducible production payload measurements. Automated tests supplement manual keyboard, screen-reader, contrast and physical-device review; they do not certify WCAG conformance.
